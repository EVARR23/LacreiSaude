...
SECRET_KEY = 'django-insecure-yk5xb7d=f6tt2e9n=t0_rz%84xx4^=u_hdq3*vv&tyb_b2fw=k'
...
JAZZMIN_SETTINGS = {
    "site_logo": "img/lacrei_logo.jpg",  # Logo to use for your site, must be present in static files, used for brand on top left
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": "Lacrei Saúde",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Lacrei Saúde",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Lacrei Saúde",
    ...
    "welcome_sign": "Bem vindo(a) a lacrei saúde!",

    # Copyright on the footer
    "copyright": "Lacrei Saúde",
    ...
    "api.profissional": "fas fa-user-md",
    "api.consulta": "fas fa-calendar-check",
    },
    ...
    "search_model": ["products.consulta"],
